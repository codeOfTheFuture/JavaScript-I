...
// Stretch
let car33 = [...inventory].filter(car => {
  if (car.id === 33) {
    return car;
  }
});

console.log(car33[0].car_year, car33[0].car_make, car33[0].car_model);
...
// Stretch
let alphaCarModel = inventory.map(function(car) {
...
// Stretch
const carYears = [...inventory].map(function(car) {
  return car.car_year;
});
...
// Stretch
const oldCars = [...inventory].filter(function(car) {
